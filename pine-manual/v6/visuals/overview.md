...
> [!TIP]
> Scripts can also use `display.*` arguments to show or hide [input](https://www.tradingview.com/pine-script-docs/concepts/inputs/) values next to the script title in the status line and Data Window.
