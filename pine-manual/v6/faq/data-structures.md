...
-   [array.insert()](https://www.tradingview.com/pine-script-reference/v6/#fun_array.insert) inserts a new element at the specified index and increases the index of existing elements at or after the insertion index by one. It accepts both positive and [negative indices](https://www.tradingview.com/pine-script-docs/language/arrays/#negative-indexing), which reference an element’s position starting from the beginning of the array or from the end, respectively.
