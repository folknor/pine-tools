...
#### Use the `max_bars_back` parameter {#use-the-max_bars_back-parameter}
...
#### Use the larger historical reference on early bars {#use-the-larger-historical-reference-on-early-bars}
...
### Historical buffer errors in realtime drawings {#historical-buffer-errors-in-realtime-drawings}
