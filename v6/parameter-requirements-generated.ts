 ...
 * Generated: 2025-12-23T15:57:09.404Z
...
export const PINE_FUNCTIONS: Record<string, FunctionSignatureSpec> = {
	...
	alertcondition: {
		...
		requiredParams: ["condition", "title", "message"],
		optionalParams: [],
	...
	"array.fill": {
		...
		requiredParams: ["id", "value", "index_from", "index_to"],
		optionalParams: [],
	...
	"array.max": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"The nth greatest value to return, where zero is the greatest. Optional. The default is zero.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"array.min": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"The nth smallest value to return, where zero is the smallest. Optional. The default is zero.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"array.new_bool": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series bool",
				description:
					"Initial value of all array elements. Optional. The default is 'false'.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"array.new_linefill": {
		...
		requiredParams: ["size", "initial_value"],
		optionalParams: [],
	...
	"array.slice": {
		...
		requiredParams: ["id", "index_from", "index_to"],
		optionalParams: [],
	...
	barcolor: {
		...
		requiredParams: ["color", "offset", "editable", "title", "display"],
		optionalParams: ["show_last"],
		signature:
			"barcolor(color, offset, editable, show_last, title, display) → void",
		parameters: [
			{
			...
			},
			{
				...
				type: "input int",
				description:
					"Optional. The number of bars, counting backwards from the most recent bar, on which the function can draw.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				description:
					"Controls where the barcolor is displayed. Possible values are: display.none, display.all. Default is display.all.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	bgcolor: {
		...
		requiredParams: ["color", "offset", "editable", "title", "display"],
		optionalParams: ["show_last", "force_overlay"],
		signature:
			"bgcolor(color, offset, editable, show_last, title, display, force_overlay) → void",
		parameters: [
			{
			...
			},
			{
				...
				type: "input plot_simple_display",
				description:
					"Controls where the bgcolor is displayed. Possible values are: display.none, display.all. Default is display.all.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.new": {
		...
		parameters: [
			...
			},
			{
				...
				description:
					"The formatting of the displayed text. Formatting options support addition. For example, text.format_bold + text.format_italic will make the text both bold and italicized. Possible values: text.format_none, text.format_bold, text.format_italic. Optional. The default is text.format_none.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"box.set_left": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Bar index or bar time of the left border. Note that objects positioned using xloc.bar_index cannot be drawn further than 500 bars into the future.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_right": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Bar index or bar time of the right border. Note that objects positioned using xloc.bar_index cannot be drawn further than 500 bars into the future.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_rightbottom": {
		...
		requiredParams: ["id", "right", "bottom"],
		optionalParams: [],
	...
	"box.set_text_font_family": {
		...
		requiredParams: ["id", "text_font_family"],
		optionalParams: [],
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The font family of the text. Possible values: font.family_default, font.family_monospace.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_text_halign": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The horizontal alignment of a box's text. Possible values: text.align_left, text.align_center, text.align_right.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_text_size": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int/string",
				description:
					"Size of the box's text. The size can be any positive integer, or one of the size.* built-in constant strings. The constant strings and their equivalent integer values are: size.auto (0), size.tiny (8), size.small (10), size.normal (14), size.large (20), size.huge (36).",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_text_valign": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The vertical alignment of the box's text. Possible values: text.align_top, text.align_center, text.align_bottom.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"box.set_xloc": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"The bar index or timestamp for the left border of the box.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series int",
				description:
					"The bar index or timestamp for the right border of the box.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series string",
				description:
					"Determines whether the box treats the left and right arguments as bar indices or timestamps. Possible values: xloc.bar_index and xloc.bar_time. If the value is xloc.bar_index, the arguments represent bar indices. If xloc.bar_time, the arguments represent UNIX timestamps.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"chart.point.new": {
		...
		requiredParams: ["time", "index", "price"],
		optionalParams: [],
	...
	dayofmonth: {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					'Optional. Specifies the time zone of the returned day number. The value can be a time zone string in UTC/GMT offset notation (e.g., "UTC-5") or IANA time zone database notation (e.g., "America/New_York"). The default is syminfo.timezone.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	fill: {
		...
		parameters: [
			...
			},
			{
				...
				type: "input plot_simple_display",
				description:
					"Controls where the fill is displayed. Possible values are: display.none, display.all. Default is display.all.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	hline: {
		...
		parameters: [
			...
			},
			{
				...
				description:
					"Style of the rendered line. Possible values are: hline.style_solid, hline.style_dotted, hline.style_dashed. Optional argument.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "input plot_simple_display",
				description:
					"Controls where the hline is displayed. Possible values are: display.none, display.all. Default is display.all.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	indicator: {
		...
		parameters: [
			...
			},
			{
				...
				type: "const string",
				description:
					"Specifies the formatting of the script's displayed values. Possible values: format.inherit, format.price, format.volume, format.percent. Optional. The default is format.inherit.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "const string",
				description:
					'Adds multi-timeframe functionality to simple scripts. When specified, a "Timeframe" field will be included in the "Calculation" section of the script\'s "Settings/Inputs" tab. The field\'s default value will be the argument supplied, whose format must conform to timeframe string specifications. To specify the chart\'s timeframe, use an empty string or the timeframe.period variable. The parameter cannot be used with scripts using Pine Script® drawings. Optional. The default is timeframe.period.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "const int",
				description:
					'Limits the initial calculation of a script to the last number of bars specified. When specified, a "Calculated bars" field will be included in the "Calculation" section of the script\'s "Settings/Inputs" tab. Optional. The default is 0, in which case the script executes on all available bars.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "const bool",
				description:
					"Optional. Controls whether all plots and drawings appear behind the chart display (if true) or in front of it (if false). This parameter only takes effect when the overlay parameter is true. The default is true.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"input.bool": {
		...
		requiredParams: ["defval", "title", "tooltip", "inline", "group"],
		optionalParams: ["confirm", "display", "active"],
		signature:
			"input.bool(defval, title, tooltip, inline, group, confirm, display, active) → input bool",
		parameters: [
			{
		...
		parameters: [
			{
				...
				type: "const enum",
				description:
					'Determines the default value of the input, which users can change in the script\'s "Settings/Inputs" tab. When the options parameter has a specified tuple of enum fields, the tuple must include the defval.',
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				description:
					"A list of options to choose from. Optional. By default, the titles of all of the enum's fields are available in the dropdown. Passing a tuple as the options argument limits the list to only the included fields.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"input.price": {
		...
		parameters: [
			...
			},
			{
				...
				type: "const bool",
				description:
					"Optional. If true, the script prompts the user to set the input's initial value by clicking a point on the chart. If inputs of other types require confirmation, the \"Confirm inputs\" dialog box also displays this input's field, allowing final adjustments to the value before the script starts to run. The default is false.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"input.source": {
		...
		requiredParams: ["defval", "title", "tooltip", "inline", "group"],
		optionalParams: ["display", "active", "confirm"],
		signature:
			"input.source(defval, title, tooltip, inline, group, display, active, confirm) → series float",
		parameters: [
			{
	...
	"input.text_area": {
		...
		requiredParams: ["defval", "title", "tooltip", "group"],
		optionalParams: ["confirm", "display", "active"],
		signature:
			"input.text_area(defval, title, tooltip, group, confirm, display, active) → input string",
		parameters: [
		...
		parameters: [
			{
				...
				type: "chart.point",
				description:
					"A chart.point object that specifies the label's location.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "series string",
				description:
					"See description of x argument. Possible values: xloc.bar_index and xloc.bar_time. Default is xloc.bar_index.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series string",
				description:
					"Possible values are yloc.price, yloc.abovebar, yloc.belowbar. If yloc=yloc.price, y argument specifies the price of the label position. If yloc=yloc.abovebar, label is located above bar. If yloc=yloc.belowbar, label is located below bar. Default is yloc.price.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "series int/string",
				description:
					"Optional. Size of the label. Accepts a positive int value or one of the built-in size.* constants. The constants and their equivalent numeric sizes are: size.auto (0), size.tiny (~7), size.small (~10), size.normal (12), size.large (18), size.huge (24). The default value is size.normal, which represents the numeric size of 12.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series string",
				description:
					"Label text alignment. Possible values: text.align_left, text.align_center, text.align_right. Default value is text.align_center.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"label.set_size": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int/string",
				description:
					"Size of the label. Accepts a positive int value or one of the built-in size.* constants. The constants and their equivalent numeric sizes are: size.auto (0), size.tiny (~7), size.small (~10), size.normal (12), size.large (18), size.huge (24). The default value is size.normal, which represents the numeric size of 12.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"label.set_textalign": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"Label text alignment. Possible values: text.align_left, text.align_center, text.align_right.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"line.new": {
		...
		optionalParams: ["extend", "force_overlay"],
		signature:
			"line.new(first_point, second_point, xloc, extend, color, style, width, force_overlay) → series line",
		parameters: [
			{
				...
				type: "chart.point",
				description:
					"A chart.point object that specifies the line's starting coordinate.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "chart.point",
				description:
					"A chart.point object that specifies the line's ending coordinate.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series string",
				description:
					"See description of x1 argument. Possible values: xloc.bar_index and xloc.bar_time. Default is xloc.bar_index.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "series string",
				description:
					"Line style. Possible values: line.style_solid, line.style_dotted, line.style_dashed, line.style_arrow_left, line.style_arrow_right, line.style_arrow_both.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"line.set_x1": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Bar index or bar time. Note that objects positioned using xloc.bar_index cannot be drawn further than 500 bars into the future.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"linefill.new": {
		...
		requiredParams: ["line1", "line2", "color"],
		optionalParams: [],
	...
	"math.avg": {
		...
		requiredParams: ["number0", "number1"],
		optionalParams: [],
	...
	"matrix.add_col": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Optional. The index of the new column. Must be a value from 0 to matrix.columns(id). All existing columns with indices that are greater than or equal to this value increase their index by one. The default is matrix.columns(id).",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "any array type",
				description:
					"Optional. The ID of an array to use as the new column. If the matrix is empty, the array can be of any size. Otherwise, its size must equal matrix.rows(id). By default, the function inserts a column of na values.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"matrix.add_row": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Optional. The index of the new row. Must be a value from 0 to matrix.rows(id). All existing rows with indices that are greater than or equal to this value increase their index by one. The default is matrix.rows(id).",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "any array type",
				description:
					"Optional. The ID of an array to use as the new row. If the matrix is empty, the array can be of any size. Otherwise, its size must equal matrix.columns(id). By default, the function inserts a row of na values.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"matrix.reshape": {
		...
		requiredParams: ["id", "rows", "columns"],
		optionalParams: [],
	...
	"matrix.set": {
		...
		requiredParams: ["id", "row", "column", "value"],
		optionalParams: [],
	...
	"matrix.sort": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series sort_order",
				description:
					"The sort order. Possible values: order.ascending (default), order.descending.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"matrix.submatrix": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series int",
				description:
					"Index of the row where the extraction will end (non inclusive). Optional. The default value is matrix.rows().",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "series int",
				description:
					"Index of the column where the extraction will end (non inclusive). Optional. The default value is matrix.columns().",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"matrix.swap_columns": {
		...
		requiredParams: ["id", "column1", "column2"],
		optionalParams: [],
	...
	nz: {
		...
		parameters: [
			...
			},
			{
				...
				type: "simple color",
				description:
					'Optional. The value the function uses to replace na values in the source series. The default depends on the source type: 0 for "int", 0.0 for "float", or #00000000 for "color".',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	plot: {
		...
		parameters: [
			...
			},
			{
				...
				description:
					"Type of plot. Possible values are: plot.style_line, plot.style_stepline, plot.style_stepline_diamond, plot.style_histogram, plot.style_cross, plot.style_area, plot.style_columns, plot.style_circles, plot.style_linebr, plot.style_areabr, plot.style_steplinebr. Default value is plot.style_line.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "input int/float",
				description:
					"The price value used as the reference level when rendering plot with plot.style_histogram, plot.style_columns or plot.style_area style. Default is 0.0.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "input bool",
				description:
					"If true then plot points will be joined with line, applicable only to plot.style_cross and plot.style_circles styles. Default is false.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	plotchar: {
		...
		parameters: [
			...
			},
			{
				...
				type: "input string",
				description:
					"Location of shapes on the chart. Possible values are: location.abovebar, location.belowbar, location.top, location.bottom, location.absolute. Default value is location.abovebar.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "const string",
				description:
					"Size of characters on the chart. Possible values are: size.auto, size.tiny, size.small, size.normal, size.large, size.huge. Default is size.auto.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	plotshape: {
		...
		parameters: [
			...
			},
			{
				...
				type: "input string",
				description:
					"Type of plot. Possible values are: shape.xcross, shape.cross, shape.triangleup, shape.triangledown, shape.flag, shape.circle, shape.arrowup, shape.arrowdown, shape.labelup, shape.labeldown, shape.square, shape.diamond. Default value is shape.xcross.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "const string",
				description:
					"Size of shapes on the chart. Possible values are: size.auto, size.tiny, size.small, size.normal, size.large, size.huge. Default is size.auto.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"polyline.new": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The style of the polyline. Possible values: line.style_solid, line.style_dotted, line.style_dashed, line.style_arrow_left, line.style_arrow_right, line.style_arrow_both. Optional. The default is line.style_solid.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"request.currency_rate": {
		...
		optionalParams: ["ignore_invalid_currency"],
		signature:
			"request.currency_rate(from, to, ignore_invalid_currency) → series float",
		parameters: [
			{
			...
			},
			{
				...
				type: "series string",
				description:
					'The currency in which the value is to be converted. Possible values: a three-letter string with the currency code in the ISO 4217 format (e.g. "USD"), or one of the built-in variables that return currency codes, like syminfo.currency or currency.USD.',
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"request.dividends": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"Input string. Possible values include: dividends.net, dividends.gross. Default value is dividends.gross.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				description:
					"Merge strategy for the requested data position. Possible values: barmerge.lookahead_on, barmerge.lookahead_off. Default value is barmerge.lookahead_off starting from version 3. Note that behavour is the same on real-time, and differs only on history.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"request.earnings": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"Input string. Possible values include: earnings.actual, earnings.estimate, earnings.standardized. Default value is earnings.actual.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"request.economic": {
		...
		requiredParams: ["country_code", "field"],
		optionalParams: ["gaps", "ignore_invalid_symbol"],
		signature:
			"request.economic(country_code, field, gaps, ignore_invalid_symbol) → series float",
		parameters: [
			{
	...
	"request.financial": {
		...
		requiredParams: ["symbol", "financial_id", "period"],
		optionalParams: ["gaps", "ignore_invalid_symbol", "currency"],
		signature:
			"request.financial(symbol, financial_id, period, gaps, ignore_invalid_symbol, currency) → series float",
		parameters: [
			{
			...
			},
			{
				...
				type: "series string",
				description:
					'Reporting period. Possible values are "TTM", "FY", "FQ", "FH", "D".',
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"request.security": {
		...
		requiredParams: ["symbol", "timeframe", "expression"],
		optionalParams: [
			"gaps",
			"lookahead",
			"ignore_invalid_symbol",
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"Symbol or ticker identifier of the requested data. Use an empty string or syminfo.tickerid to request data using the chart's symbol. To retrieve data with additional modifiers (extended sessions, dividend adjustments, non-standard chart types like Heikin Ashi and Renko, etc.), create a custom ticker ID for the request using the functions in the ticker.* namespace.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series string",
				description:
					"Timeframe of the requested data. Use an empty string or timeframe.period to request data from the chart's timeframe or the timeframe specified in the indicator() function. To request data from a different timeframe, supply a valid timeframe string. See here to learn about specifying timeframe strings.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				description:
					"The expression to calculate and return from the requested context. It can accept a built-in variable like close, a user-defined variable, an expression such as ta.change(close) / (high - low), a function call that does not use Pine Script® drawings, an object, a collection, or a tuple of expressions.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"request.seed": {
		...
		requiredParams: ["source", "symbol", "expression"],
		optionalParams: ["ignore_invalid_symbol", "calc_bars_count"],
		signature:
			"request.seed(source, symbol, expression, ignore_invalid_symbol, calc_bars_count) → series <type>",
		parameters: [
			{
			...
			},
			{
				...
				type: "simple int",
				description:
					"Optional. If specified, the function requests only this number of values from the end of the symbol's history and calculates expression as if these values are the only available data, which might improve calculation speed in some cases. The default is the same as the number of chart bars available for the symbol and timeframe. The maximum number of bars that the function can attempt to retrieve depends on the intrabar limit of the user's plan. However, the request cannot retrieve more bars than are available in the dataset.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"request.splits": {
		...
		requiredParams: ["ticker", "field"],
		optionalParams: ["gaps", "lookahead", "ignore_invalid_symbol"],
		signature:
			"request.splits(ticker, field, gaps, lookahead, ignore_invalid_symbol) → series float",
		parameters: [
			{
			...
			},
			{
				...
				type: "series string",
				description:
					"Input string. Possible values include: splits.denominator, splits.numerator.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"str.repeat": {
		...
		parameters: [
			...
			},
			{
				...
				type: "const int",
				description:
					"Number of times to repeat the source string. Must be greater than or equal to 0.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "const string",
				description:
					"String to inject between repeated values. Optional. The default is empty string.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"str.replace": {
		...
		requiredParams: ["source", "target", "replacement"],
		optionalParams: ["occurrence"],
		signature:
			"str.replace(source, target, replacement, occurrence) → const string",
		parameters: [
			{
	...
	"str.split": {
		...
		requiredParams: ["string", "separator"],
		optionalParams: [],
	...
	"str.substring": {
		...
		requiredParams: ["source", "begin_pos"],
		optionalParams: ["end_pos"],
		...
		parameters: [
			...
			},
			{
				...
				type: "const int",
				description:
					"The ending position. It is exclusive (the extracted string does NOT include that position's character). Optional. The default is the length of the source string.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	strategy: {
		...
		parameters: [
			...
			},
			{
				...
				type: "const bool",
				description:
					"Optional. When true, the Broker Emulator uses lower timeframe data during backtesting on historical bars to achieve more realistic results. The default is false. Only Premium and higher-tier plans have access to this feature.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "const bool",
				description:
					"When true, forces strategies running on Heikin Ashi charts to fill orders using actual OHLC prices, for more realistic results. Optional. The default is false.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"strategy.close": {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"Optional. Additional notes on the filled order. If the value is not an empty string, the Strategy Tester and the chart show this text for the order instead of the automatically generated exit identifier. The default is an empty string.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The number of contracts/lots/shares/units to close when an exit order fills. If specified, the command uses this value instead of qty_percent to determine the order size. The default is na, which means the order size depends on the qty_percent value.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. A value between 0 and 100 representing the percentage of the open trade quantity to close when an exit order fills. The percentage calculation depends on the total size of the open trades with the id entry identifier. The command ignores this parameter if the qty value is not na. The default is 100.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series string",
				description:
					'Optional. Custom text for the alert that fires when an order fills. If the "Message" field of the "Create Alert" dialog box contains the {{strategy.order.alert_message}} placeholder, the alert message replaces the placeholder with this text. The default is an empty string.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series bool",
				description:
					"Optional. If true, the closing order executes on the same tick when the strategy places it, ignoring the strategy properties that restrict execution to the opening tick of the following bar. The default is false.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series bool",
				description:
					'Optional. If true when the command creates an order, the strategy does not trigger an alert when that order fills. This parameter accepts a "series" value, meaning users can control which orders trigger alerts when they execute. The default is false.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"The identifier of the order, which corresponds to an entry ID in the strategy's trades after the order fills. If the strategy opens a new position after filling the order, the order's ID becomes the strategy.position_entry_name value. Strategy commands can reference the order ID to cancel or modify pending orders and generate exit orders for specific open trades. The Strategy Tester and the chart display the order ID unless the command specifies a comment value.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				description:
					"The direction of the trade. Possible values: strategy.long for a long trade, strategy.short for a short one.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The number of contracts/shares/lots/units in the resulting open trade when the order fills. The default is na, which means that the command uses the default_qty_type and default_qty_value parameters of the strategy() declaration statement to determine the quantity.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The limit price of the order. If specified, the command creates a limit or stop-limit order, depending on whether the stop value is also specified. The default is na, which means the resulting order is not of the limit or stop-limit type.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The stop price of the order. If specified, the command creates a stop or stop-limit order, depending on whether the limit value is also specified. The default is na, which means the resulting order is not of the stop or stop-limit type.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series string",
				description:
					"Optional. The name of the order's One-Cancels-All (OCA) group. When a pending order with the same oca_name and oca_type parameters executes, that order affects all unfilled orders in the group. The default is an empty string, which means the order does not belong to an OCA group.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "input string",
				description:
					"Optional. Specifies how an unfilled order behaves when another pending order with the same oca_name and oca_type values executes. Possible values: strategy.oca.cancel, strategy.oca.reduce, strategy.oca.none. The default is strategy.oca.none.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series string",
				description:
					"Optional. Additional notes on the filled order. If the value is not an empty string, the Strategy Tester and the chart show this text for the order instead of the specified id. The default is an empty string.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"The identifier of the orders, which corresponds to an exit ID in the strategy's trades after an order fills. Strategy commands can reference the order ID to cancel or modify pending exit orders. The Strategy Tester and the chart display the order ID unless the command includes a comment* argument that applies to the filled order.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The take-profit price. If this parameter and profit are not na, the command places a take-profit order only at the price level expected to trigger an exit first. The default is na.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			...
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The stop-loss price. If this parameter and loss are not na, the command places a stop-loss order only at the price level expected to trigger an exit first. The default is na.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"The identifier of the order, which corresponds to an entry or exit ID in the strategy's trades after the order fills. If the strategy opens a new position after filling the order, the order's ID becomes the strategy.position_entry_name value. Strategy commands can reference the order ID to cancel or modify pending orders and generate exit orders for specific open trades. The Strategy Tester and the chart display the order ID unless the command specifies a comment value.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			...
			},
			{
				...
				type: "series int/float",
				description:
					"Optional. The number of contracts/shares/lots/units to trade when the order fills. The default is na, which means that the command uses the default_qty_type and default_qty_value parameters of the strategy() declaration statement to determine the quantity.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"strategy.risk.max_cons_loss_days": {
		...
		requiredParams: ["count", "alert_message"],
		optionalParams: [],
	...
	"strategy.risk.max_drawdown": {
		...
		requiredParams: ["value", "type", "alert_message"],
		optionalParams: [],
	...
	"ta.alma": {
		...
		requiredParams: ["series", "length", "offset", "sigma"],
		optionalParams: ["floor"],
	...
	"ta.bb": {
		...
		requiredParams: ["series", "length", "mult"],
		optionalParams: [],
		signature:
			"ta.bb(series, length, mult) → [series float, series float, series float]",
		parameters: [
	...
	"ta.correlation": {
		...
		requiredParams: ["source1", "source2", "length"],
		optionalParams: [],
	...
	"ta.dmi": {
		...
		requiredParams: ["diLength", "adxSmoothing"],
		optionalParams: [],
		signature:
			"ta.dmi(diLength, adxSmoothing) → [series float, series float, series float]",
		parameters: [
	...
	"ta.kc": {
		...
		requiredParams: ["series", "length", "mult", "useTrueRange"],
		optionalParams: [],
		signature:
			"ta.kc(series, length, mult, useTrueRange) → [series float, series float, series float]",
		parameters: [
	...
	"ta.linreg": {
		...
		requiredParams: ["source", "length", "offset"],
		optionalParams: [],
	...
	"ta.macd": {
		...
		requiredParams: ["source", "fastlen", "slowlen", "siglen"],
		optionalParams: [],
		signature:
			"ta.macd(source, fastlen, slowlen, siglen) → [series float, series float, series float]",
		parameters: [
	...
	"ta.percentile_linear_interpolation": {
		...
		requiredParams: ["source", "length", "percentage"],
		optionalParams: [],
		signature:
			"ta.percentile_linear_interpolation(source, length, percentage) → series float",
		parameters: [
	...
	"ta.pivot_point_levels": {
		...
		requiredParams: ["type", "anchor"],
		optionalParams: ["developing"],
	...
	"ta.stoch": {
		...
		requiredParams: ["source", "high", "low", "length"],
		optionalParams: [],
	...
	"ta.supertrend": {
		...
		requiredParams: ["factor", "atrPeriod"],
		optionalParams: [],
		signature:
		...
		parameters: [
			{
				...
				type: "simple bool",
				description:
					"Defines how the function calculates the result when the previous bar's close is na. If true, the function returns the bar's high - low value. If false, it returns na.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"ta.tsi": {
		...
		requiredParams: ["source", "short_length", "long_length"],
		optionalParams: [],
	...
	"ta.valuewhen": {
		...
		requiredParams: ["condition", "source", "occurrence"],
		optionalParams: [],
	...
	"table.cell": {
		...
		requiredParams: ["table_id", "column", "row", "width", "height", "tooltip"],
		optionalParams: [
			"text",
			"text_color",
			"text_halign",
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The horizontal alignment of the cell's text. Optional. The default value is text.align_center. Possible values: text.align_left, text.align_center, text.align_right.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series string",
				description:
					"The vertical alignment of the cell's text. Optional. The default value is text.align_center. Possible values: text.align_top, text.align_center, text.align_bottom.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int/string",
				description:
					"Size of the object. The size can be any positive integer, or one of the size.* built-in constant strings. The constant strings and their equivalent integer values are: size.auto (0), size.tiny (8), size.small (10), size.normal (14), size.large (20), size.huge (36). The default value is size.normal or 14.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	"table.cell_set_bgcolor": {
		...
		requiredParams: ["table_id", "column", "row", "bgcolor"],
		optionalParams: [],
	...
	"table.cell_set_height": {
		...
		requiredParams: ["table_id", "column", "row", "height"],
		optionalParams: [],
	...
	"table.cell_set_text": {
		...
		requiredParams: ["table_id", "column", "row", "text"],
		optionalParams: [],
	...
	"table.cell_set_text_color": {
		...
		requiredParams: ["table_id", "column", "row", "text_color"],
		optionalParams: [],
		signature:
			"table.cell_set_text_color(table_id, column, row, text_color) → void",
		parameters: [
	...
	"table.cell_set_text_font_family": {
		...
		requiredParams: ["table_id", "column", "row", "text_font_family"],
		optionalParams: [],
		signature:
			"table.cell_set_text_font_family(table_id, column, row, text_font_family) → void",
		parameters: [
	...
	"table.cell_set_text_halign": {
		...
		requiredParams: ["table_id", "column", "row", "text_halign"],
		optionalParams: [],
		signature:
			"table.cell_set_text_halign(table_id, column, row, text_halign) → void",
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"The horizontal alignment of a cell's text. Possible values: text.align_left, text.align_center, text.align_right.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"table.cell_set_text_valign": {
		...
		requiredParams: ["table_id", "column", "row", "text_valign"],
		optionalParams: [],
		signature:
			"table.cell_set_text_valign(table_id, column, row, text_valign) → void",
		parameters: [
	...
	"table.cell_set_tooltip": {
		...
		requiredParams: ["table_id", "column", "row", "tooltip"],
		optionalParams: [],
	...
	"table.cell_set_width": {
		...
		requiredParams: ["table_id", "column", "row", "width"],
		optionalParams: [],
	...
	"table.clear": {
		...
		requiredParams: ["table_id", "start_column", "start_row"],
		optionalParams: ["end_column", "end_row"],
		signature:
			"table.clear(table_id, start_column, start_row, end_column, end_row) → void",
		parameters: [
			{
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"Position of the table. Possible values are: position.top_left, position.top_center, position.top_right, position.middle_left, position.middle_center, position.middle_right, position.bottom_left, position.bottom_center, position.bottom_right.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"table.set_position": {
		...
		requiredParams: ["table_id", "position"],
		optionalParams: [],
	...
	"ticker.inherit": {
		...
		requiredParams: ["from_tickerid", "symbol"],
		optionalParams: [],
	...
	"ticker.kagi": {
		...
		requiredParams: ["symbol", "reversal"],
		optionalParams: [],
	...
	"ticker.linebreak": {
		...
		requiredParams: ["symbol", "number_of_lines"],
		optionalParams: [],
	...
	"ticker.modify": {
		...
		requiredParams: ["tickerid", "session", "adjustment"],
		optionalParams: ["backadjustment", "settlement_as_close"],
		signature:
			"ticker.modify(tickerid, session, adjustment, backadjustment, settlement_as_close) → simple string",
		parameters: [
			{
				...
				type: "simple string",
				description:
					"Symbol name with exchange prefix, e.g. 'BATS:MSFT', 'NASDAQ:MSFT' or tickerid with session and adjustment from the ticker.new() function.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "simple string",
				description:
					"Session type. Optional argument. Possible values: session.regular, session.extended. Session type of the current chart is syminfo.session. If session is not given, then syminfo.session value is used.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"ticker.new": {
		...
		description:
			"Creates a ticker identifier for requesting additional data for the script.",
		requiredParams: ["prefix", "ticker", "session", "adjustment"],
		optionalParams: ["backadjustment", "settlement_as_close"],
		signature:
			"ticker.new(prefix, ticker, session, adjustment, backadjustment, settlement_as_close) → simple string",
		parameters: [
			{
				...
				type: "simple string",
				description:
					"Exchange prefix. For example: 'BATS', 'NYSE', 'NASDAQ'. Exchange prefix of main series is syminfo.prefix.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "simple string",
				description:
					"Ticker name. For example 'AAPL', 'MSFT', 'EURUSD'. Ticker name of the main series is syminfo.ticker.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"ticker.pointfigure": {
		...
		requiredParams: ["symbol", "source", "style", "param", "reversal"],
		optionalParams: [],
		signature:
			"ticker.pointfigure(symbol, source, style, param, reversal) → simple string",
		parameters: [
			...
			},
			{
				...
				type: "simple string",
				description:
					'Specifies the ticker\'s box size assignment method. Possible values: "ATR" for Average True Range sizing, "Traditional" to use a fixed size, or "PercentageLTP" to use a percentage of the last trading price.',
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "simple int/float",
				description:
					'Represents the ticker\'s "ATR length" value if the style value is "ATR", "Box size" value if the style is "Traditional", or "Percentage" value if the style is "PercentageLTP".',
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
	...
	"ticker.renko": {
		...
		requiredParams: ["symbol", "style", "param"],
		optionalParams: ["request_wicks", "source"],
		signature:
			"ticker.renko(symbol, style, param, request_wicks, source) → simple string",
		parameters: [
			{
			...
			},
			{
				...
				type: "simple bool",
				description:
					"Specifies if wick values are returned for Renko bricks. When true, high and low values requested from a symbol using the ticker formed by this function will include wick values when they are present. When false, high and low will always be equal to either open or close. Optional. The default is false. A detailed explanation of how Renko wicks are calculated can be found in our Help Center.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	time: {
		...
		optionalParams: ["session", "bars_back", "timeframe_bars_back"],
		signature:
			"time(timeframe, session, bars_back, timeframe_bars_back) → series int",
		parameters: [
			{
				...
				type: "series string",
				description:
					"The timeframe of the timestamp calculation. If the value is an empty string, the function uses the script's main timeframe.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
			},
			{
				...
				type: "series string",
				description:
					"Optional. The session string for filtering times. The function returns a timestamp if the time is in the specified session, or na if the time is outside the session. If the argument is an empty string, the function uses the default, which is the symbol's session.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
			},
			{
				...
				type: "series int",
				description:
					"Optional. The bar offset on the script's main timeframe. If the value is positive, the function finds the bar that is N bars before the current bar on the main timeframe, then retrieves the timestamp of the corresponding bar on the timeframe specified by the timeframe argument. If the value is a negative number from -1 to -500, the function calculates the expected timestamp of the timeframe bar corresponding to N bars after the current bar on the main timeframe. The default is 0.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
		...
		parameters: [
			{
				...
				type: "series string",
				description:
					"String formatted according to the User manual's timeframe string specifications.",
				optional: false,
				required: true,
				explicitlyOptional: false,
				explicitlyRequired: true,
		...
		parameters: [
			{
				...
				type: "simple string",
				description:
					"Timeframe string in timeframe string specifications format. Optional. The default is timeframe.period.",
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
	...
	weekofyear: {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					'Optional. Specifies the time zone of the returned week number. The value can be a time zone string in UTC/GMT offset notation (e.g., "UTC-5") or IANA time zone database notation (e.g., "America/New_York"). The default is syminfo.timezone.',
				optional: true,
				required: false,
				explicitlyOptional: true,
				explicitlyRequired: false,
