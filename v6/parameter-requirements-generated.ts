	...
	"request.seed": {
		...
		parameters: [
			...
			},
			{
				...
				type: "simple int",
				description:
					"Optional. If specified, the function requests only this number of values from the end of the symbol's history and calculates expression as if these values are the only available data, which might improve calculation speed in some cases. The default is 100,000. For information about the bar limits for different TradingView plans, see the Chart bars section of the Limitations page in the User Manual.",
				explicitlyOptional: true,
				explicitlyRequired: false,
				optional: true,
				required: false,
	...
	"str.tostring": {
		...
		parameters: [
			...
			},
			{
				...
				type: "simple string",
				description:
					"Format string. Accepts these format.* constants: format.mintick, format.percent, format.volume. Optional. The default value is '#.##########'.",
				explicitlyOptional: true,
				explicitlyRequired: false,
				optional: true,
				required: false,
	...
	time: {
		...
		parameters: [
			...
			},
			{
				...
				type: "series string",
				description:
					"Session specification. Optional argument, session of the symbol is used by default. An empty string is interpreted as the session of the symbol.",
				explicitlyOptional: true,
				explicitlyRequired: false,
				optional: true,
				required: false,
			},
			{
				...
				type: "series int",
				description:
					"Optional. The bar offset on the script's main timeframe. If the value is positive, the function retrieves the timestamp of the bar N bars back relative to the current bar on the main timeframe. If the value is a negative number from -1 to -500, the function retrieves the expected time of a future bar on that timeframe. The default is 0.",
				explicitlyOptional: true,
				explicitlyRequired: false,
				optional: true,
				required: false,
