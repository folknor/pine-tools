...
export const V6_FUNCTIONS: Record<string, PineItem> = {
	indicator: {
		...
		syntax:
			"indicator(title, shorttitle=na, overlay=false, format=format.inherit, precision=na, scale=scale.right, max_bars_back=na, timeframe=na, timeframe_gaps=true, explicit_plot_zorder=false, max_lines_count=50, max_labels_count=50, max_boxes_count=50, max_polylines_count=50)",
		returns: "void",
	...
	bgcolor: {
		...
		syntax:
			"bgcolor(color, offset=0, editable=true, show_last=0, title=na, display=display.all, overlay=false)",
		returns: "void",
		category: "plot",
	},
	alertcondition: {
...
export function getAllCompletionItems(): {
