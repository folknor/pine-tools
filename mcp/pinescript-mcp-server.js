		...
		tools: [
			{
				...
				description:
					"Validates a Pine Script v6 file and returns syntax errors, type mismatches, and warnings. Uses the comprehensive validator with full semantic analysis.",
				inputSchema: {
					type: "object",
					properties: {
						file_path: {
						...
						code: {
							type: "string",
							description:
								"Optional: Pine Script code string to validate (if not providing file_path)",
						},
					},
					oneOf: [{ required: ["file_path"] }, { required: ["code"] }],
				},
			},
		],
	};
